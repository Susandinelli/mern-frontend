...
export function WednesdayPlanner() {
  ...
  async function onSubmit(e) {
    ...
    await fetch("https://planner-backend-664m.onrender.com/wednesday/add", {
      method: "POST",
      headers: {
  ...
  async function getTask() {
    let { data } = await axios.get("https://planner-backend-664m.onrender.com/wednesday");
  ...
  async function onDelete(_id) {
    try {
      await axios.delete(`https://planner-backend-664m.onrender.com/wednesday/${_id}`);
    } catch (err) {
