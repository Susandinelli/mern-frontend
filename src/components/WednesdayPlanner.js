...
export function WednesdayPlanner() {
  ...
  async function onSubmit(e) {
    ...
    await fetch("https://localhost:10000/wednesday/add", {
      method: "POST",
      headers: {
  ...
  async function getTask() {
    let { data } = await axios.get("https://localhost:10000/wednesday");
  ...
  async function onDelete(_id) {
    try {
      await axios.delete(`https://localhost:10000/wednesday/${_id}`);
    } catch (err) {
