...
export function ThursdayPlanner() {
  ...
  async function onSubmit(e) {
    ...
    await fetch("https://localhost:10000/thursday/add", {
      method: "POST",
      headers: {
  ...
  async function getTask() {
    let { data } = await axios.get("https://localhost:10000/thursday");
  ...
  async function onDelete(_id) {
    try {
      await axios.delete(`https://localhost:10000/thursday/${_id}`);
    } catch (err) {
