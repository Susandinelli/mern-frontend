...
export function ThursdayPlanner() {
  ...
  async function onSubmit(e) {
    ...
    await fetch("https://planner-backend-664m.onrender.com/thursday/add", {
      method: "POST",
      headers: {
  ...
  async function getTask() {
    let { data } = await axios.get("https://planner-backend-664m.onrender.com/thursday");
  ...
  async function onDelete(_id) {
    try {
      await axios.delete(`https://planner-backend-664m.onrender.com/thursday/${_id}`);
    } catch (err) {
