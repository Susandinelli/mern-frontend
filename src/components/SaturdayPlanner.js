...
export function SaturdayPlanner() {
  ...
  async function onSubmit(e) {
    ...
    await fetch("https://localhost:10000/saturday/add", {
      method: "POST",
      headers: {
  ...
  async function getTask() {
    let { data } = await axios.get("https://localhost:10000/saturday");
  ...
  async function onDelete(_id) {
    try {
      await axios.delete(`https://localhost:10000/saturday/${_id}`);
    } catch (err) {
